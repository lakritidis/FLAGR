...
class RAM:
    ...
    def __init__(self, eval_pts):
        ...
        if platform == "linux" or platform == "linux2":
            ...
            self.flagr_lib = ctypes.CDLL(os.getcwd() + "/flagr.dll")

        elif platform == "darwin":
            self.flagr_lib = ctypes.CDLL(os.getcwd() + "/flagr.dylib")
    ...
    def check_get_input(self, f, df):
        ...
        if len(f) > 0:
            ...
            self.input_file = "A dataframe is required"
    ...
    def check_get_rels_input(self, rf, rdf):
        ...
        if len(rf) > 0:
            ...
            self.rels_file = "A rels dataframe is required"
        else:
            self.rels_file = ""
